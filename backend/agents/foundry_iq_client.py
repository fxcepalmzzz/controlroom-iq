...
def retrieve_from_foundry_iq(query: str, drill: dict[str, Any]) -> dict[str, Any]:
    ...
    try:
        ...
        prompt = (
            ...
            "Return a concise supervision-oriented answer. "
            "Do not invent policies. "
            "If evidence is insufficient, say that more evidence is needed.\n\n"
            "Format your answer exactly as:\n"
            "1. Evidence bullets: 3 short bullet points.\n"
            "2. Supervisor action: 1 short sentence.\n"
            "3. Source documents: list the source document names.\n\n"
